...
const Leaderboard: React.FC = () => {
    ...
    const leaderboardData = useMemo(() => {
        ...
        const otherUsers = [
            { name: 'Saanvi J.', XP: 2450 }, { name: 'Tanmay G.', XP: 2100 },
            { name: 'Alex R.', XP: 1890 }, { name: 'Maria S.', XP: 1720 },
            { name: 'Kenji T.', XP: 1550 }, { name: 'Chloe B.', XP: 1280 },
            { name: 'Liam P.', XP: 920 }, { name: 'Fatima A.', XP: 1150 },
            { name: 'Noah L.', XP: 1600 },
        ];
